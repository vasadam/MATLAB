function [Z24_f,MAE_BVE,MAE_pers] = eniac_core_2(Z0, Z24_a, ... % initial and analysis fields
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%  Calculate the BVE and Persistence MAE
ERROR = abs(Z24_a(2:ysize-1,2:xsize-1)-Z24_f(2:ysize-1,2:xsize-1));
MAE_BVE = sum(ERROR(:)) / ((ysize-2)*(xsize-2));
ERROR = abs(Z24_a(2:ysize-1,2:xsize-1)-Z0(2:ysize-1,2:xsize-1));
MAE_pers = sum(ERROR(:)) / ((ysize-2)*(xsize-2));
